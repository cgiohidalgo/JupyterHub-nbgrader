...
c.CourseDirectory.course_id = "Course_MISC"

# Update this list with other assignments you want
c.CourseDirectory.db_assignments = [dict(name="Semana_1")]

# Change the students in this list with that actual students in
# your course
c.CourseDirectory.db_students = [
    dict(id="victor.bucheli", first_name="Victor", last_name="Bucheli"),
    dict(id="juan.delgado", first_name="Juan", last_name="delgado"),
    dict(id="daniel.diaz", first_name="Daniel", last_name="Diaz"),
    dict(id="wilmer.escobar", first_name="Wilmer", last_name="Escobar"),
    dict(id="sandra.guerrero", first_name="Sandra", last_name="Guerrero"),
    dict(id="fabian.hernandez", first_name="Fabian", last_name="Hernandez"),
    dict(id="dalila.pachajoa", first_name="Dalila", last_name="Pachajoa"),
    dict(id="wilmer.perez", first_name="Wilmer", last_name="Perez"),
    dict(id="jorge.rivera", first_name="Jorge", last_name="Rivera"),
    dict(id="felipe.roa", first_name="Felipe", last_name="Roa"),
    dict(id="jonnathan.rosero", first_name="Jonnathan", last_name="Rosero"),
    dict(id="oswaldo.ruiz", first_name="Oswaldo", last_name="Ruiz"),
    dict(id="javier.santacruz", first_name="Javier", last_name="Santacruz")
]

c.IncludeHeaderFooter.header = "source/header.ipynb"

c.CourseDirectory.root = '/home/admin/Course_MISC'

c.ClearSolutions.code_stub = {
    "python": "# Tu código aquí\nraise Reemplace este texto con su código",
    "javascript": "// your code here\nthrow new Error();"
}
c.ClearSolutions.text_stub = "Reemplace este texto con su respuesta."
